...
public class ControlFlowStatements {
    ...
    int limitNumber = 0;
       ...
       Scanner input = new Scanner(System.in);
        ...
        } while (number < 0); // the number inputted by the user is less than 0 keep asking the user to enter positive number. If the number is positive then success message returned
...
/* ----------------------------- JUMP STATEMENT EXCERCISES ------------------------*/
        ...
        * */
        ...
        // TASK: find the first multiple of 5 in the array
